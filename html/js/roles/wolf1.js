$(function() {
    ...
    for(var i = 1; i <= n; i++)
    {
        if(roles[i-1] == 300 && i != player)
            $("#susAdd").append("<div class=\"roles\"><p id=\"p" + i + "\">" + names[i-1] + "</p><p class=\"deathp\">人狼</p><div class=\"cp_ipselect cp_sl01\"><select id=\"sus" + i + "\" required><option value=\"0\">疑わしくない</option><option value=\"1\">疑わしい</option></select></div></div>");
